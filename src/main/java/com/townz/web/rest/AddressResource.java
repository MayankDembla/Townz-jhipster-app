...
/**
 * REST controller for managing {@link com.townz.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "townzAddress";
    ...
    public List<Address> getAllAddresses(@RequestParam(required = false) String filter) {
        if ("city-is-null".equals(filter)) {
            log.debug("REST request to get all Addresss where city is null");
