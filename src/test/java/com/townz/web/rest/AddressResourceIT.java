...
import com.townz.domain.Address;
import com.townz.repository.AddressRepository;
...
public class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().address(DEFAULT_ADDRESS).location(DEFAULT_LOCATION).pincode(DEFAULT_PINCODE);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().address(UPDATED_ADDRESS).location(UPDATED_LOCATION).pincode(UPDATED_PINCODE);
        return address;
    }
    ...
    public void updateAddress() throws Exception {
        ...
        updatedAddress.address(UPDATED_ADDRESS).location(UPDATED_LOCATION).pincode(UPDATED_PINCODE);
